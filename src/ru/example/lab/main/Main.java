...
import ru.example.lab.list.Task1;
import ru.example.lab.list.Task2;
...
import ru.example.lab.geometry.Circle;
import ru.example.lab.geometry.Square;
import ru.example.lab.geometry.Rectangle;
import ru.example.lab.geometry.Triangle;
import ru.example.lab.geometry.Shape;

/**
 * Главный класс программы, содержащий точку входа и меню для выполнения лабораторных заданий.
 */
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            switch (taskNumber) {
                case 1:
                    // Задание 1.9 - Работа со списком студентов и их оценками
                    ...
                    while (true) {
                        ...
                        switch (action) {
                            ...
                            case 3:
                                // Создание нового студента с копированием оценок
                ...
                case 2:
                    // Задание 2.3 - Работа с телефонной книгой
                    ...
                    while (true) {
                        ...
                        switch (action) {
                            ...
                            case 10:
                                ...
                                System.out.println("Имена, начинающиеся на '" + prefix + "': " +
                                        Arrays.toString(phoneBook.getNamesByPrefix(prefix)));
                                break;
                ...
                case 3:
                    // Задание 3.5 - Работа с трехмерной точкой
                    double x = 0, y = 0, z = 0;
                ...
                case 4:
                    // Задание 4.4 - Работа с фигурами и их площадями
                    while (true) {
                ...
                case 5:
                    // Задание 5.3 - Работа с геометрическими фигурами
                    ...
                    while (true) {
                        ...
                        switch (choice) {
                            case 1: // Круг
                                ...
                                shapes.add(new Circle(new Point2D(centerX, centerY), radius));
                            ...
                            case 2: // Квадрат
                                ...
                                shapes.add(new Square(new Point2D(topLeftX, topLeftY), side));
                ...
                case 6:
                    // Задание 5.6 - Работа с замкнутой ломаной
                    ...
                    while (true) {
                        ...
                        try {
                            ...
                            closedPolygon.addPoint(xCoord, yCoord);
                    ...
                    while (true) {
                        ...
                        switch (action) {
                            case 1:
                                ...
                                points.add(new Point2D(coordX, coordY));
                ...
                case 8:
                    // Задание 8 - Вывод структуры пакетов
                    Task8.printStructure();
                    break;

                case 9:
                    // Задание 9 - Демонстрация работы лабораторной работы
                    Task9.main(new String[0]);
                    break;

                case 10:
                    // Задание 10 - Калькулятор степеней
                    ...
                    try {
                        double result = Task10.calculate(xStr, yStr);
                ...
                case 11:
                    // Задание 11 - Демонстрация клонирования
                    Task11.demonstrate();
                    break;
