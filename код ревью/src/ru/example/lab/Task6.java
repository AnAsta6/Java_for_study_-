...
/**
 * Представляет студента с именем и набором оценок, с возможностью вычисления средней оценки и проверки на отличника.
 */
public class Task6 {
     ...
     * @return true, если студент является отличником, иначе false.
     */
    ...
    /**
     * Возвращает текстовое представление студента в формате "Имя: [оценка1, оценка2, ..., оценкаN], Средний балл: X.XX, Студент [не] является отличником.".
