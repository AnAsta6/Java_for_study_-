...
/**
 * Основной класс для выполнения различных заданий, связанных с точками и студентами.
 */
public class Main {
        ...
        while (true) {
            ...
            switch (taskNumber) {
                        ...
                        switch (action) {
                            ...
                            case 2:
                                ...
                                if (studentIndex >= 0 && studentIndex < students.size()) {
                                    ...
                                    System.out.println("Оценка изменена: " + studentToEdit);
                                } else {
                            ...
                            case 3:
                                ...
                                if (sourceStudentIndex >= 0 && sourceStudentIndex < students.size()) {
                                    ...
                                    System.out.println("Новый студент добавлен: " + copiedStudent);
                                } else {
                                    System.out.println("Неверный номер студента.");
                                }
                                break;
                ...
                case 4:
                    ...
                    double x1Task4 = scanner.nextDouble();
                    System.out.print("Введите координату Y: ");
                    double y1Task4 = scanner.nextDouble();
                    Task1 point1Task4 = new Task1(x1Task4, y1Task4);
                    System.out.println(point1Task4);

                    System.out.println("Введите координаты для второй точки:");
                    System.out.print("Введите координату X: ");
                    double x2Task4 = scanner.nextDouble();
                    System.out.print("Введите координату Y: ");
                    double y2Task4 = scanner.nextDouble();
                    Task1 point2Task4 = new Task1(x2Task4, y2Task4);
                    System.out.println(point2Task4);

                    System.out.println("Введите координаты для третьей точки:");
                    System.out.print("Введите координату X: ");
                    double x3Task4 = scanner.nextDouble();
                    System.out.print("Введите координату Y: ");
                    double y3Task4 = scanner.nextDouble();
                    Task1 point3Task4 = new Task1(x3Task4, y3Task4);
                    System.out.println(point3Task4);
                    break;
